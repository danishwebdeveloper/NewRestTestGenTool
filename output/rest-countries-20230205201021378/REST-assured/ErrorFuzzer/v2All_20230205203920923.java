...
@Order(2119)
public class v2All_20230205203920923{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request0_query_fields = 5323070420205283328;
		//Build request
 		RequestSpecification request0 = RestAssured.given();
		request0.queryParam("fields" , request0_query_fields);
		//Build Response
		Response response0 = request0.when().get(baseURL+"/v2/all");
	...
	@Test
	public void test_v2All_20230205203920923()  throws JSONException{
		test0();
	}
}
