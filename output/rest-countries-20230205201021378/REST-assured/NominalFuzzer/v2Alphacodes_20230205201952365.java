...
@Order(65)
public class v2Alphacodes_20230205201952365{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request1_path_capital = "P";
		//Build request
		...
		//OPERATION 0
		//Parameter initialization
		Object request0_query_codes = JsonPath.read(response1_response_body , "$[19]['currencies'][0]['code']");
		Object request0_query_fields = "imbibes dk";
		//Build request
 		RequestSpecification request0 = RestAssured.given();
		request0.queryParam("codes" , request0_query_codes);
		request0.queryParam("fields" , request0_query_fields);
		//Build Response
		Response response0 = request0.when().get(baseURL+"/v2/alpha");
		String response0_response_body = response0.getBody().asString();

		Assertions.assertFalse(response0.getStatusCode()>=500,"StatusCode 5xx: The test sequence was not executed successfully.");
	}
	@Test
	public void test_v2Alphacodes_20230205201952365()  throws JSONException{
		test0();
	}
}
