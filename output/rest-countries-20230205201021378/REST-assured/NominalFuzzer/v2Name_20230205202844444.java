...
@Order(385)
public class v2Name_20230205202844444{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request0_path_name = JsonPath.read(response1_response_body , "$[1]['currencies'][0]['name']");
		//Build request
	...
	@Test
	public void test_v2Name_20230205202844444()  throws JSONException{
		test0();
	}
}
