...
@Order(97)
public class v3Capital_20230205201958121{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request2_path_capital = "P";
		//Build request
		...
		//OPERATION 1
		//Parameter initialization
		Object request1_path_demonym = JsonPath.read(response2_response_body , "$[1]['demonym']");
		//Build request
		...
		//OPERATION 0
		//Parameter initialization
		Object request0_path_capital = JsonPath.read(response1_response_body , "$[0]['capital'][0]");
		//Build request
	...
	@Test
	public void test_v3Capital_20230205201958121()  throws JSONException{
		test0();
	}
}
