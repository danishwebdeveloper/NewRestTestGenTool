...
@Order(1076)
public class v3Alphacodes_20230205203152383{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request1_query_codes = JsonPath.read(response2_response_body , "$[2]['currencies'][0]['code']");
		//Build request
 		RequestSpecification request1 = RestAssured.given();
		request1.queryParam("codes" , request1_query_codes);
		//Build Response
		Response response1 = request1.when().get(baseURL+"/v2/alpha");
	...
	@Test
	public void test_v3Alphacodes_20230205203152383()  throws JSONException{
		test0();
	}
}
