...
@Order(186)
public class v3Region_20230205202556414{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request1_path_subregion = JsonPath.read(response2_response_body , "$[2]['subregion']");
		//Build request
		...
		//OPERATION 0
		//Parameter initialization
		Object request0_path_region = JsonPath.read(response1_response_body , "$[5]['region']");
		//Build request
	...
	@Test
	public void test_v3Region_20230205202556414()  throws JSONException{
		test0();
	}
}
