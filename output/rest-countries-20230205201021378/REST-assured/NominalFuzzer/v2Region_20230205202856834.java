...
@Order(442)
public class v2Region_20230205202856834{
...
String baseURL ="https://restcountries.com";
	...
	private void test0() throws JSONException{
		...
		Object request1_path_name = JsonPath.read(response2_response_body , "$[28]['name']");
		//Build request
 		RequestSpecification request1 = RestAssured.given();
		request1.pathParam("name" , request1_path_name);
		request1.queryParam("fullText" , request1_query_fullText);
		//Build Response
		Response response1 = request1.when().get(baseURL+"/v3/name/{name}");
	...
	@Test
	public void test_v2Region_20230205202856834()  throws JSONException{
		test0();
	}
}
